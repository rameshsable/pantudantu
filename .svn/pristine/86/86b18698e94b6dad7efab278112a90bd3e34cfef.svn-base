...
<script src="${pageContext.request.contextPath}/resources/advanceBooking/Booking.js"charset='utf-8'></script>
	...
	<!-- following are the online files-->
...
<c:forEach var="list1" items="${birthdaylist}">
	<script>
				packageId.push("${list1.birthdayId}");
				price.push("${list1.price}");// it enters child name into array named customer
	</script>
</c:forEach>
	          ...
	          <div style="margin-top: 20px;"
				...
				aria-hidden="true">&times;</button>
				 ...
				 <div style="margin-top: 20px;"
					...
					<button type="button" class="close" data-dismiss="alert"
				aria-hidden="true">&times;</button>
					<strong>Warning: </strong>please Enter No Of  Adult .
				</div>
				<div style="margin-top: 20px;"
					class="alert alert-danger alert-dismissable"
					id="childselect">
					<button type="button" class="close" data-dismiss="alert"
				aria-hidden="true">&times;</button>
					<strong>Warning: </strong>please Enter No Of Child .
				</div>
				<div style="margin-top: 20px;"
					class="alert alert-danger alert-dismissable"
					id="endTimeselect">
					<button type="button" class="close" data-dismiss="alert"
				aria-hidden="true">&times;</button>
					<strong>Warning: </strong>please Enter End Time .
				</div>
				<div style="margin-top: 20px;"
					class="alert alert-danger alert-dismissable"
					id="startTimeselect">
					<button type="button" class="close" data-dismiss="alert"
				aria-hidden="true">&times;</button>
					<strong>Warning: </strong>please Enter Start Time .
				</div>
				<div style="margin-top: 20px;"
					class="alert alert-danger alert-dismissable"
					id="dateselect1">
				...
				<div style="margin-top: 20px;"
					class="alert alert-danger alert-dismissable"
					id="packageNameselect">
					<button type="button" class="close" data-dismiss="alert"
				aria-hidden="true">&times;</button>
					<strong>Warning: </strong>please Select Type .
				</div>
				...
				<div style="margin-top: 20px;"
					...
					<button type="button" class="close" data-dismiss="alert"
				aria-hidden="true">&times;</button>
					<strong>Warning: </strong>please check availability .
				</div>
					...
					<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
																				...
																				<div class="col-xs-3">
																					<label>Mobile No 1</label><input type="text"
																						class="form-control mobCodeClass required"
																						placeholder="mobile No1" name="mno1" id="mno1"
																						value="${mob1}" autocomplete="on"
																						onChange="fetchData(this.value);" onblur="fetchData(this.value);">
																				</div>
<div class="col-xs-3">
					<label>Country</label> 
					...
					<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
																				...
																				<div class="col-xs-3">
																					<label>Mobile No 2</label><input type="text"
																						class="form-control mobCodeClass "
											...
											<div style="width:100%;">
														...
														<form action="#" id="advanceBooking">
															...
															<table class="table" id="monthlypass"  class="form-control">
																<tbody>
																	...
																	<tr>
																		<td align="center">
																		<select name="birtdaytype"
																			id="birtdaytype" class="form-control">

																			<c:forEach var="vis" items="${birthdaylist}"
																varStatus="theCount">
																<option value="${vis.birthdayId}" selected>${vis.packagetype}</option>
																		...
																		<td align="center"><input type="text"
																			...
																			id="datepicker3" readonly="readonly" /></td>
																		...
																		<td align="center"><input type="text"
																			class="form-control" name="startTime" id="endTime"
																			readonly="readonly" /></td>	
													...
													<div class="col-xs-3">
																...
																<input type="text" class="form-control" onblur=" return totalAmount();" onchange=" return totalAmount();"
																placeholder="0" name="noofchild" id="noofchild" / >
						 							</div>
						 							
						 							<div class="col-xs-3">
																<label>No of Adult</label>
																<input type="text" class="form-control"
																placeholder="0" name="noofadult" id="noofadult" onblur=" return totalAmount();" onchange=" return totalAmount();">
						 							</div>
													...
													<!-- <div class="col-xs-3">
														<label>  Search </label>
														<input type="text"
														class="form-control" name="avalabilitydate" id="datepicker5"
														readonly="readonly" />
													...
													<div class="col-xs-3">
														...
														<input type="Button" value="Check Availability"
															id="availability" onclick="return viewAvailability();"
													...
													<div class="col-xs-3">
														...
														<input type="Button" value="Save And Print Bill"
															id="saveandprint" onclick="return saveAdvanceBooking();"
															class="btn btn-primary btn-sm  " />

													</div>
													
													<div class="col-xs-3"></div><div class="col-xs-12" id="hr">
...
<input id="payingAmt" class="form-control" type="text" placeholder="Amount" id="payingAmt" name="payingAmt" >
</div>
</div>
...
<br><br><br><br>
	<input type="button" onClick="closePopUp(),addPayingAmount();"value="OK" class="btn btn_danger"  />
										...
										<div id="printlight" class="white_content" class="white_content" style="width:1000px;min-height:500px!important;
											margin-left: 300px !important;margin-right: 100px !important;overflow:hidden!important;border:20px solid #ffffff!important;">
  ...
  <script>
	...
	<script>
		/* $(function() {
		  ...
		  $("#datepicker4").datepicker({ dateFormat: 'dd/mm/yy',changeMonth: true,
		        ...
		        yearRange: '1990:2050'}).datepicker("setDate", new Date());
		  var currentDate = new Date();  
		  $("#datepicker3").datepicker({ dateFormat: 'dd/mm/yy',changeMonth: true,
		        changeYear: true,
		        yearRange: '1990:2050'}).datepicker("setDate", new Date());
	...
	<script>
		...
		var d = $("#datepicker5").val();
		$.ajax({
			url : '${pageContext.request.contextPath}/viewAvailability',
			type : "GET",
			data : {
				d : "" + d
			},
