            ...
            <div class="container-fluid">
                <div class="row">
					...
					<div class="row">
						...
						<div class="col-xs-3">
								<label>Specification</label><input type="text" class="form-control" placeholder="Specification">
					    </div>
