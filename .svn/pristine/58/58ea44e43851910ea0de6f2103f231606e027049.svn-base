            ...
            <div class="container-fluid">
                <div class="row">
					...
					<div class="row">
							  ...
							  <div class="col-xs-3">
								<label>Name</label><input type="text" class="form-control" placeholder="Name">
							  </div>
							  <div class="col-xs-3">
								<label>Product Description</label><input type="text" class="form-control" placeholder="Product Description">
