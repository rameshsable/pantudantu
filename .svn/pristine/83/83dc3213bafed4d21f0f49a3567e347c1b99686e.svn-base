        ...
        <div class="span2">
                ...
                <!--    <input type="text" class="form-control" name="sonumber" id="sonumber" value="" readonly="readonly"><br>  refere it for all form-->
             	...
             	<div class="row">
					...
					<div class="col-xs-3">
						...
						<input type="text"  class="datepicker" name="datepicker1" id="datepicker1"  readonly="readonly" />
			...
			<br><br>
					...
					<div align="right">
									 ...
									 Date:
										<td align="left"><input type="text" id="attendanceDate1" name="attendanceDate" class="datepicker" /></td>
