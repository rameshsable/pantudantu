        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <!-- /.col-lg-12 -->
					<div class="col-xs-3">
								<label>Project Name</label><input type="text" class="form-control" placeholder="Project Name">
							  </div>
				...
				<div class="col-xs-3" >
					...
					<div class="col-xs-3">
								<label>Project In</label><input type="text" class="form-control" placeholder="Project In">
				    </div>
					<div class="col-xs-3">
								<label>Project Out</label><input type="text" class="form-control" placeholder="Project Out">
				    </div>
                </div>
                <!-- /.row -->
				<br><br>
