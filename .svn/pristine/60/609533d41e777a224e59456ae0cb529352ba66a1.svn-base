        ...
        <div id="page-wrapper">
			...
			<div class="row">
                    <div class="col-lg-12">
						 ...
						 <div class="col-xs-3" style="margin-top:-10px;width:300px;position:absolute;right:250px;top:40px;">
								<label>W.O. No.</label><input type="text" class="form-control" placeholder="W.O. No.">
					    </div>
					...
					<div class="row">
						...
						<div class="col-xs-3" >
								<label>Ref</label><input type="text" class="form-control" placeholder="Ref">
				    </div>
						<div class="col-xs-3">
                ...
                <div class="row">
                    ...
                    <!--<div class="col-xs-3">
								<label>Date</label><input type="text" class="form-control" placeholder="Address">
				    </div>-->
                        ...
                        <!-- /.panel-heading -->
							<div class="panel-body" >
								<div class="dataTable_wrapper">
									...
									</table></div></div><div class="row"><div class="col-sm-6"><div class="dataTables_info" id="dataTables-example_info" role="status" aria-live="polite">Showing 1 to 2 of 57 entries</div></div>
			...
			<div class="row">
			 <div class="col-xs-3">
			  ...
			  <div class="col-xs-3">
				...
				<input type="text" class="form-control " placeholder="Terms & Condition" style="background:#E8E8E8;" >
				<!--<textarea class="form-control" rows="4" style="background:#E8E8E8;" >	</textarea>-->
			  </div><br /><br />
			  
			  <div class="col-xs-3">
			 	<label>Vat No</label>
				<input type="text" class="form-control " placeholder="Vat No">
			  </div>
			  <div class="col-xs-3">
			 	<label>CST No</label>
