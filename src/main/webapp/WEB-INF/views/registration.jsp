...
<script>
	...
	function fetchData(moba) {
		...
		if (j != -1) {
			...
			document.getElementById('mon2').value = mob2[j];
    ...
    <div class="block users scrollBox table-responsive">
	          ...
	          <div style="margin-top: 20px;"
				...
				aria-hidden="true">&times;</button>
					...
					<button type="button" class="close" data-dismiss="alert"
				aria-hidden="true">&times;</button>
					<strong>Success: </strong>Customer Saved Success.
				</div>
				<!-- 
				<div style="margin-top: 20px;"
					class="alert alert-success alert-dismissable"
                ...
                <br><br>
             	...
             	<div class="row">
					...
					<div class="col-xs-3">
						...
						<input type="text" class="form-control"
					  placeholder="mother name" name="mothername" id="mothername">
...
<div class="col-xs-3">
					...
					<div class="col-xs-3">
						<label>Mobile No 2</label><input type="text" class="form-control"
							placeholder="mobile no 2" name="mon2" id="mon2" maxlength="10" >
					</div>
					<div class="col-xs-3">
					...
					<div class="col-xs-3">
						...
						<input type="text"  class="form-control" name="datepicker12" id="datepicker12"  readonly="readonly" />
			...
			<br><br>
					...
					<div class="col-xs-3">
					 ...
					 <input type="Button" value="submit" id="submit" onclick="return register() " class="btn btn-primary btn-sm "/>
