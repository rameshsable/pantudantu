    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Add Import/Eport Duty</h1>
						<div class="col-xs-3">
						...
						<div class="col-xs-3">
								<label>Duty(%)</label><input type="text" class="form-control" placeholder="Duty">
					    </div>
