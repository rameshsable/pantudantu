            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
						...
						<div class="col-xs-3">
								<label>Excise Duty(%)</label><input type="text" class="form-control" placeholder="Excise Duty">
					    </div>
