        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <!-- /.col-lg-12 -->
					 <div class="col-xs-3">
								<label>Category Name</label><input type="text" class="form-control" placeholder="Category Name">
					  </div>
				</div><br><br>
