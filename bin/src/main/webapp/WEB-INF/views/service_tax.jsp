            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
						...
						<div class="col-xs-3">
								<label>Service Tax(%)</label><input type="text" class="form-control" placeholder="Service Tax">
					    </div>
